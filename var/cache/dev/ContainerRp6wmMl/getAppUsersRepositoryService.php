...
// Returns the private 'App\Repository\AppUsersRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AppUsersRepository.php';

return $this->privates['App\Repository\AppUsersRepository'] = new \App\Repository\AppUsersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
