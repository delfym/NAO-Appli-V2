...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ObservationType' => function () {
    return ($this->privates['App\Form\ObservationType'] ?? $this->privates['App\Form\ObservationType'] = new \App\Form\ObservationType());
}, 'App\\Form\\SignupType' => function () {
    return ($this->privates['App\Form\SignupType'] ?? $this->privates['App\Form\SignupType'] = new \App\Form\SignupType());
