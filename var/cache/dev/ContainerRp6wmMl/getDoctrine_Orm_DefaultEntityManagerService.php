...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AppUsersRepository' => function () {
    return ($this->privates['App\Repository\AppUsersRepository'] ?? $this->load('getAppUsersRepositoryService.php'));
}, 'App\\Repository\\BirdsRepository' => function () {
    return ($this->privates['App\Repository\BirdsRepository'] ?? $this->load('getBirdsRepositoryService.php'));
