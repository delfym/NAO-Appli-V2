...
// Returns the private 'App\Repository\ObservationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ObservationRepository.php';

return $this->privates['App\Repository\ObservationRepository'] = new \App\Repository\ObservationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
