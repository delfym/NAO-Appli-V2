...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/observForm'), array(0 => 'ROLE_USER'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/contact'), array(0 => 'ROLE_USER'), NULL);
