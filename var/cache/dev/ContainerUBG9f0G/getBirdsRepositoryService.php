...
// Returns the private 'App\Repository\BirdsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BirdsRepository.php';

return $this->privates['App\Repository\BirdsRepository'] = new \App\Repository\BirdsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
